...
public class PdfGenerator {
    ...
    public static void pdfGeneratorRowsAndCells(String header, String fileName){
        ...
        String pdf_path = fileName;
        String pdf_title = header;
        String logo_path = "C:\\Users\\keske\\Pictures\\Screenshot_20201126-153505_Chrome.jpg";
        List<String> headers = new ArrayList<String>();
    ...
    public static void pdfGeneratorRowsAndCellsWithList1(String header, List <Customer> list, String fileName){
        Document document = new Document();
        String pdf_path = fileName;
        String pdf_title = header;
        String logo_path = "/Users/keske/Pictures/gmibank.PNG";
        List<String> headers = new ArrayList<String>();
        ...
        try{
            ...
            for(int i=0;i<list.size();i++ ) {
                ...
                table.addCell(list.get(i).getPhoneNumber());
                table.addCell(list.get(i).getState());
                table.addCell(list.get(i).getZipCode());
            }
            document.add(table);
    ...
    public static void main (String[]args){
        ...
        String header= "All Applicants Info";
        String fileName = "applicant.pdf";
